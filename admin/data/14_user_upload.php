...
//15: 等比例缩放分页图 82*83
//16: 将二张图片保存uploads
$result = mkThumbnail($des,51,51,"../img/avatar/s_".$fileName);
$result = mkThumbnail($des,128,128,"../img/avatar/m_".$fileName);
$result = mkThumbnail($des,320,230,"../img/avatar/l_".$fileName);
